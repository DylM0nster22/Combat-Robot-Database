...
- **`component`** — extra: `category` (one of `drive-motor`, `weapon-motor`, `esc-drive`, `esc-weapon`, `receiver`, `transmitter`, `battery`, `charger`, `wheel`, `hub`, `bearing`, `fastener`, `switch`, `servo`, `gearbox`, `belt-pulley`, `connector`, `misc`), `vendor`(string), `product_url`(string), `alternatives`(string[])
